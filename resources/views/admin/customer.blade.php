...
<div class="content">
    ...
    <div class="table-list" id="advanceAjaxTable">
                ...
                <thead class="text-body">
                    <tr>
                        <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId"
                            style="min-width: 4.5rem;">Order</th>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="deliveryType"
                            style="min-width: 7rem">Delivery Type</th>
                ...
                <tbody class="list">
                    <tr class="btn-reveal-trigger">
                        <td class="order py-2  ps-3 align-middle white-space-nowrap">
                            <a class="fw-semibold"
                                href="https://prium.github.io/phoenix/v1.12.0/apps/e-commerce/admin/order-details.html">
                                #2181
                            </a>
                        </td>
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal" type="button"
                                    id="order-dropdown-1" data-bs-toggle="dropdown" data-boundary="window"
                                    aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                        <path fill="currentColor"
                                            d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z">
                                        </path>
                                    </svg><!-- <span class="fas fa-ellipsis-h fs-9"></span> Font Awesome fontawesome.com -->
                                </button>
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle text-center fs-8 white-space-nowrap">
                            <span class="badge fs-10 badge-phoenix badge-phoenix-primary">
                                Processing
                                <svg class="svg-inline--fa fa-arrow-rotate-right ms-1" data-fa-transform="shrink-2"
                                    aria-hidden="true" focusable="false" data-prefix="fas"
                                    data-icon="arrow-rotate-right" role="img" xmlns="http://www.w3.org/2000/svg"
                                ...
                                </svg><!-- <span class="ms-1 fas fa-redo" data-fa-transform="shrink-2"></span> Font Awesome fontawesome.com -->
                            </span>
                        </td>
                        <td class="py-2 align-middle text-end fs-8 fw-medium">
                            $120
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap">
                            <p class="mb-0">Local Delivery</p>
                        </td>
                        <td class="py-2 align-middle text-center fs-8 white-space-nowrap">
                            <span class="badge fs-10 badge-phoenix badge-phoenix-secondary">
                                On Hold
                                <svg class="svg-inline--fa fa-ban ms-1" data-fa-transform="shrink-2"
                                ...
                                </svg><!-- <span class="ms-1 fas fa-ban" data-fa-transform="shrink-2"></span> Font Awesome fontawesome.com -->
                            </span>
                        </td>
                        <td class="py-2 align-middle text-end fs-8 fw-medium">
                            $70
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-3" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle text-center fs-8 white-space-nowrap">
                            <span class="badge fs-10 badge-phoenix badge-phoenix-warning">
                                Pending
                                <svg class="svg-inline--fa fa-bars-staggered ms-1" data-fa-transform="shrink-2"
                                    aria-hidden="true" focusable="false" data-prefix="fas"
                                ...
                                </svg><!-- <span class="ms-1 fas fa-stream" data-fa-transform="shrink-2"></span> Font Awesome fontawesome.com -->
                            </span>
                        </td>
                        <td class="py-2 align-middle text-end fs-8 fw-medium">
                            $92
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-4" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-5" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-6" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-7" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-8" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-9" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="py-2 align-middle white-space-nowrap text-end">
                            <div class="dropstart position-static d-inline-block">
                                <button class="btn btn-link text-body btn-sm dropdown-toggle btn-reveal"
                                    type="button" id="order-dropdown-10" data-bs-toggle="dropdown"
                                    data-boundary="window" aria-haspopup="true" aria-expanded="false"
                                    data-bs-reference="parent">
                                    <svg class="svg-inline--fa fa-ellipsis fs-9" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="ellipsis" role="img"
        ...
        <div class="d-flex justify-content-center mt-3"><button class="page-link disabled"
                data-list-pagination="prev" disabled=""><svg class="svg-inline--fa fa-chevron-left"
    ...
    <div class="p-3">
        ...
        <ul>
            ...
            <li>Use the <code>advanceAjaxTableInit() </code>function from <code>src/js/theme/advance-ajax-table.js
                </code>in a new JS file and update the ID.</li>
            <li>Import the file on <code>src/js/phoenix.js</code></li>
        </ul>
        <p>If you are not using Gulp based workflow:</p>
        <ul>
            <li>Give your table a unique ID.</li>
            <li>Find the <code>advanceAjaxTableInit() </code>function from <code>theme.js, </code>copy the code, and
