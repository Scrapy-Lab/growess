...
@section('content')
    ...
    <div class="Button_box">
        ...
        <div class="box_1">
            ...
            <div id="outerPopup" class="popup">
                <div class="popup-content">
                    <span class="close-btn" onclick="closeOuterPopup()">&times;</span>
                    <button class="button" id="openInnerPopupBtn" onclick="openInnerPopup()">Landing page
                        website</button>
                    <div id="innerPopup" class="popup">
                        <div class="popup-content">
                            <span class="close-btn" onclick="closeInnerPopup()">&times;</span>
    ...
    <div id="container2" style="display: none;">
        ...
        <p class="intagram_headline">Instagrams offers inspiring and seamless ways to tell your story.No matter what types
            of business you are.
