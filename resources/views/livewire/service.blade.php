<div class="container">
                    ...
                    <div class="container pop_up_box">
                        <div class="col-md-6 model_pop_up" data-bs-target="#exampleModalToggle2_website"
                            ...
                            <button class="button" wire:click="service_products(1)"
                                data-bs-target="#exampleModalToggle2_website" data-bs-toggle="modal">static</button>
                        </div>
                        <div class="col-md-6 model_pop_up" data-bs-target="#exampleModalToggle2_website"
                            data-bs-toggle="modal">
                            <img src="/assets/web_logo.png" alt="My Logo" w="10" h="10" />
                            <button class="button" wire:click="service_products(1)"
                                data-bs-target="#exampleModalToggle2_website" data-bs-toggle="modal">Brochere</button>
                        </div>
                        <div class="col-md-6 model_pop_up" data-bs-target="#exampleModalToggle2_website"
                            data-bs-toggle="modal">
                            <img src="/assets/web_logo.png" alt="My Logo" w="10" h="10" />
                            <button class="button" wire:click="service_products(1)"
                                data-bs-target="#exampleModalToggle2_website" data-bs-toggle="modal">Dynamic</button>
                        </div>
                        <div class="col-md-6 model_pop_up" data-bs-target="#exampleModalToggle2_website"
                            data-bs-toggle="modal">
                            <img src="/assets/web_logo.png" alt="My Logo" w="10" h="10" />
                            <button class="button" wire:click="service_products(1)"
                                data-bs-target="#exampleModalToggle2_website" data-bs-toggle="modal">E-Commerce</button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" wire:ignore.self id="exampleModalToggle2_lead" aria-hidden="true"
        aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header text-capitalize">
                    <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Select Your Google Ad{{ $subModalTitle }}
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="container pop_up_box">
                            <div class="col-md-6 pop_up" data-bs-target="#exampleModalToggle3_lead"
                                data-bs-toggle="modal">
                                <img src="/assets/search_ad.jpeg" alt="My Logo" w="10" h="10" />
                            </div>
                            <div class="col-md-6 pop_up" data-bs-target="#exampleModalToggle3_lead"
                                data-bs-toggle="modal">
                                <img src="/assets/call_ad.jpeg" alt="My Logo" w="10" h="10" />
                            </div>
                            <div class="col-md-6 pop_up" data-bs-target="#exampleModalToggle3_lead"
                                data-bs-toggle="modal">
                                <img src="/assets/shopping_ad.jpeg" alt="My Logo" w="10" h="10" />
                            </div>
                            <div class="col-md-6 pop_up" data-bs-target="#exampleModalToggle3_lead"
                                data-bs-toggle="modal">
                                <img src="/assets/youtube_ad.jpeg" alt="My Logo" w="10" h="10" />
                            </div>
                            <div class="col-md-6 pop_up" data-bs-target="#exampleModalToggle3_lead"
                                data-bs-toggle="modal">
                                <img src="/assets/display_ad.jpeg" alt="My Logo" w="10" h="10" />
                            </div>
    ...
    <div class="modal fade" wire:ignore.self id="exampleModalToggle2_digital" aria-hidden="true"
        aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header text-capitalize">
